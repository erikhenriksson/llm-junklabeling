...
- **Navigational**: Content **specifically designed for navigating or structuring** a webpage, such as menus, links (e.g., "Home", "About Us"), or buttons like "Click here". *Do not confuse this with normal, valuable text.*
...
- **Clean**: None of the above junk categories, indicating linguistic content that should be retained for pre-training LLMs
