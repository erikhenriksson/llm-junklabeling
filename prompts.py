...
3. If the line is entirely useful and relevant to the document’s primary purpose, output exactly Clean. If the line contains junk, briefly describe all types of junk present, separated by semicolons.
...
- Identify and label **Spammy Content** that is primarily intended to manipulate search engines or users (e.g., excessive SEO keywords, clickbait).
...
Example 5 (Target line with irrelevant technical details):
---
...
3. Label common web phrases that aren't junk as Common web artifact.
4. Distinguish Structural HTML (junk) from Informative HTML (useful).
5. Identify Spammy Content meant to manipulate.
6. Ensure your outputs are concise and consistent.
"""
